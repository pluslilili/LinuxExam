...
public class updatebook extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://152.136.210.168/b_book";
   final static String USER = "root";
   final static String PASS = "WODEQQshi@255632";
   final static String SQL_UPDATE_BOOK = "UPDATE t_book SET bookname= ? , bookage = ? WHERE bookid=?";
   ...
   private int updatebook(book req) {
      ...
      try {
         ...
         stmt.setString(1, req.bookname);
         stmt.setString(2, req.bookage);
         stmt.setInt(3, req.bookid);
